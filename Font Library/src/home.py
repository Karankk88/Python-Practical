...
class C2W_TkinterLibraryApp:
    ...
    def setup_ui(self):
        ...
        img_path=os.path.join(script_directory,"assests/1.jpeg")
        ...
        # tk_color="#{:82x}{:02x}{:02x}".format(*rgba_color[:3])
        tk_color = "#de3730"  
    ...
    def c2w_show_font_tab(self):
        if self.font_library_opened :
            ...
            self.c2w_button_label4=ttk.Button(self.c2w_right_frame,text="MSSans Serif",style="Rounded.TButton",command=self.c2w_sanserifClicked)
    ...
    def c2w_poppinClicked(self):
        self.c2w_show_label.config(text=self.input_label.get(),font=("Poppis",30,"bold"))
    ...
    def c2w_sanserifClicked(self):
        self.c2w_show_label.config(text=self.input_label.get(),font=("MS Sans Sarif",30,"bold"))
