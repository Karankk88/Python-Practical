...
class Ui_C2W_PythonInfoDialog(object):
    ...
    def setupUi(self, Widget):
        ...
        pixmap1 = QtGui.QPixmap('/home/vaibhav/python_project/c2w.png')
        ...
        self.c2w_frame.setGeometry(QtCore.QRect(0, 50, monitor_width, monitor_height - 50))
        ...
        self.c2w_tabWidget.setGeometry(QtCore.QRect(0, 0, monitor_width, monitor_height - 50))
        ...
        self.c2w_tab_5 = QtWidgets.QWidget()
        self.c2w_tab_5.setObjectName("tab_5")
        self.c2w_tabWidget.addTab(self.c2w_tab_5, "")
        self.c2w_tabStyle = """
        height:200px;
        width:50px;
        ...
        self.c2w_pdf_viewer = PDFViewer('report adarsh.pdf')
        ...
        layout.addWidget(self.c2w_pdf_viewer)
        self.c2w_pdf_viewer = PDFViewer('python Histroy.pdf')
        layout = QtWidgets.QVBoxLayout(self.c2w_tab_4)
        layout.addWidget(self.c2w_pdf_viewer)
        self.c2w_pdf_viewer = PDFViewer('python Histroy.pdf')
        layout = QtWidgets.QVBoxLayout(self.c2w_tab_5)
        layout.addWidget(self.c2w_pdf_viewer)
    ...
    def retranslateUi(self, Widget):
        ...
        self.c2w_tabWidget.setTabText(self.c2w_tabWidget.indexOf(self.c2w_tab),_translate("Widget", "Introduction"))
        self.c2w_tabWidget.setTabText(self.c2w_tabWidget.indexOf(self.c2w_tab_2),_translate("Widget", "History"))
        self.c2w_tabWidget.setTabText(self.c2w_tabWidget.indexOf(self.c2w_tab_3),_translate("Widget", "Index"))
        self.c2w_tabWidget.setTabText(self.c2w_tabWidget.indexOf(self.c2w_tab_4),_translate("Widget", "Practice"))
        self.c2w_tabWidget.setTabText(self.c2w_tabWidget.indexOf(self.c2w_tab_5),_translate("Widget", "Mahesh"))
